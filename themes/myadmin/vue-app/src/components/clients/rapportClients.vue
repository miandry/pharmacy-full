      ...
      <div class="bg-white rounded-lg w-full max-w-md">
        <div class="p-6">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2"
                >{{ formLabels.notes }}</label
              >
              <textarea
                v-model="formData.notes"
                rows="2"
                class="w-full px-3 py-2 border border-gray-200 !rounded-button text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                :placeholder="formPlaceholders.notes"
              ></textarea>
            </div>
    ...
    const statistics = ref([
      {
        ...
        label: "Total Clients",
        value: "247",
        icon: "ri-user-line text-xl text-primary",
        bgColor: "bg-blue-100"
      },
      {
        id: 2,
        label: "Avec Assurance",
        value: "189",
        icon: "ri-shield-check-line text-xl text-secondary",
      ...
      },
      {
        ...
        value: "23",
        icon: "ri-user-add-line text-xl text-orange-500",
      ...
      },
      {
        ...
        label: "CA Total",
        value: "12,4M Ar",
        icon: "ri-money-dollar-circle-line text-xl text-purple-500",
